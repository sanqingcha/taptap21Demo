...
let jsCls = blueprint.tojs<typeof UE.Game.Game.GameMap.Blueprint.Enemy.BP_Enemy.BP_Enemy_C>(ucls);
interface BP_Enemy extends UE.Game.Game.GameMap.Blueprint.Enemy.BP_Enemy.BP_Enemy_C { }
 ...
 *
 */
class BP_Enemy implements BP_Enemy {
    /**
     * 从数据表结构体批量初始化黑板值
...
blueprint.mixin(jsCls, BP_Enemy);
